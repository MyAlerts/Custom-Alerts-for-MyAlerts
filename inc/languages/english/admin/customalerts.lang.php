...
$l['customalerts_pushalerts_desc'] = "Push a new alert to your users according to specified conditions. You might select more than one condition holding CTRL.";
...
$l['customalerts_add_conditions'] = "Conditions";
$l['customalerts_add_conditions_desc'] = "Choose the conditions of the alert generation. Hold CTRL to select multiple conditions.";
...
$l['customalerts_error_noconditions'] = "You didn't specified any condition.";
...
$l['customalerts_success_uidandgroup'] = "The alert was pushed successfully to the users in the specified conditions.";
$l['customalerts_success_uidandgroup_forced'] = "The alert was pushed successfully to the users in the specified conditions with forcing option set to on, so the users <em>surely</em> received the alert.";